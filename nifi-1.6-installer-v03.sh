...
# Add NiFi service profile
addgroup nifi_batch_group
useradd nifi_batch_di_01 -d /home/nifi_batch_di_01 -G nifi_batch_group
chown -R nifi_batch_di_01:nifi_batch_group /usr/hdp/current/nifi
